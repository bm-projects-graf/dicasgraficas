...
Adobe Photoshop
Abre a imagem
Vai a `Imagem → Modo → Cor CMYK`
O Photoshop avisa que vais perder qualidade — confirma
Guarda como nova versão (mantém o RGB original separado, para outras utilizações)
...
`Ficheiro → Novo`
Em "Modo de cor", escolhe CMYK
Trabalha sempre nesse espaço
