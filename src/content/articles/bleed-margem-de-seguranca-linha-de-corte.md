...
Quando crias um documento novo (`Ficheiro → Novo → Documento`), na janela de configuração há uma secção Bleed e slug
Em Bleed, escreve `3 mm` em todas as quatro caixas (cima, baixo, dentro, fora)
Confirma e o documento abre com uma linha vermelha a 3 mm das bordas — essa é a tua área de bleed
Estende cores e imagens de fundo até à linha vermelha
Quando exportares para PDF (`Ficheiro → Exportar`), na secção Marcas e bleeds, marca Use Document Bleed Settings e ativa Crop Marks
Como adicionar bleed no Adobe Illustrator
No Illustrator, defines o bleed na criação do documento:
`Ficheiro → Novo`
Na janela de configuração, há uma secção Bleed
Escreve `3 mm` em todas as caixas
O Illustrator vai mostrar uma área vermelha à volta do teu artboard
Estende cores até essa linha vermelha
Para exportar, vai a `Ficheiro → Guardar como → Adobe PDF`, escolhe predefinição PDF/X-1a ou PDF/X-4, e na secção Marks and Bleeds marca Use Document Bleed Settings
...
Faz o teu design normalmente
Em `Partilhar → Descarregar`, escolhe PDF impressão (não PDF padrão)
Marca a opção Crop marks and bleed
Descarrega
...
Bleed de 3 mm estendido em todas as bordas externas
Texto e elementos importantes a pelo menos 3-5 mm de margem das linhas de corte
PDF exportado com marcas de corte e bleed visíveis
