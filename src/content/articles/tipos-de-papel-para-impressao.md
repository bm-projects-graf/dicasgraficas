---
title: "Tipos de papel para impressão: guia para todos os projetos"
description: "Couché, offset, reciclado, kraft, linho. Os papéis mais usados na impressão profissional, quando faz sentido cada um, e como escolher para o teu próximo projeto."
pubDate: 2026-05-02
category: "Papel e suportes"
keywords: "tipos de papel impressão, papel couché, papel offset, papel reciclado"
readingTime: "10 min"
featured: true
---
...
<div class="tech-box">
<div class="tech-label">Dica prática</div>
<p>Para projetos que misturam texto longo e fotografia (catálogos detalhados, livros ilustrados), o couché mate é quase sempre a escolha mais inteligente. A leitura é mais confortável e as imagens continuam a ter qualidade.</p>
</div>
...
**Onde se usa:** miolos de livros, cadernos, blocos de notas, papel de carta, envelopes, formulários, jornais (uma versão mais barata).
...
**100% pós-consumo:** o padrão de ouro. Feito a partir de papel que já foi usado e descartado. Visualmente costuma ter um tom ligeiramente acinzentado e textura mais visível. Algumas marcas reconhecidas: Cyclus, Cocoon Offset.
...
**Kraft:** o papel castanho clássico, originalmente usado para sacos de mercearia. Hoje é símbolo de embalagem artesanal e marcas com posicionamento "natural". Imprime-se mal a 4 cores (a base castanha "puxa" tudo), mas é excelente para impressão a uma cor (preto ou cor especial), ou com trabalhos de hot-stamping.
...
**Cartão duplex:** duas camadas coladas. Permite ter um lado branco impresso e outro lado natural ou em cor diferente. Padrão em embalagens.
...
- **Cartões de visita** → Cartolina 300-350g, couché mate ou brilhante (com laminado é o padrão premium)
