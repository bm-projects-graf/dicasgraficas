---
title: "UX vs design gráfico: o que muda quando o design tem de funcionar"
description: "Design gráfico, UI e UX explicados sem jargão: onde acabam as semelhanças e começam as diferenças, porque o UX se preocupa com o comportamento e não só com a imagem, e como um designer gráfico transita para o digital."
pubDate: 2026-07-15
category: "Design gráfico"
keywords: "UX vs design gráfico, UX UI, user experience, design de interação, design digital, diferença UX design gráfico"
readingTime: "11 min"
featured: false
---
...
Este artigo arruma os conceitos, mostra o que muda quando o design passa de **imagem** para **experiência**, e como o [design gráfico](/artigos/o-que-e-o-design-grafico-essencia/) é a base de onde tudo isto nasce.

## Três siglas, três focos

Comecemos por separar os termos que mais se confundem:

- **Design gráfico:** a [disciplina](/artigos/o-que-e-o-design-grafico-essencia/) de comunicar visualmente uma mensagem. Tradicionalmente associado a artefactos (muitas vezes estáticos): cartazes, logótipos, embalagem, paginação, e também imagens digitais.
...
<div class="tech-box">
<div class="tech-label">A analogia do restaurante</div>
<p>Imagina um restaurante. O <strong>design gráfico</strong> é o menu, o logótipo, a decoração, a comunicação visual. O <strong>UI</strong> é a forma e a disposição da mesa, dos talheres, dos botões do menu digital. O <strong>UX</strong> é a <strong>experiência inteira</strong>: a facilidade de reservar, o tempo de espera, a simpatia do empregado, a clareza do menu, o conforto da cadeira, a facilidade de pagar. Pode ter um menu lindíssimo (ótimo design gráfico) e uma experiência péssima (mau UX) se demorares uma hora a ser servido. <strong>UX é tudo o que acontece, não só o que se vê.</strong></p>
</div>
...
- **Tipografia:** a [legibilidade e o tom](/artigos/anatomia-de-uma-letra/) das letras importam em ambos.
- **Cor:** [comunicar e orientar](/artigos/teoria-da-cor-para-designers/) com cor, garantindo contraste e acessibilidade.
- **[Grelha](/artigos/grelha-e-composicao-design-grafico/) e composição:** organizar o espaço com ordem e ritmo.
- **Consistência:** um [sistema visual](/artigos/branding-e-identidade-visual/) coerente cria confiança e reconhecimento.
...
Não. O **UI** é a camada **visual** (botões, cores, tipos); o **UX** é a **experiência completa** (fluxos, usabilidade, investigação, satisfação). Pode haver bom UI com mau UX (bonito mas frustrante) e vice-versa.

**"UX é design gráfico para ecrãs."**
Isso é mais o **UI**. O **UX** vai além do visual: inclui investigação, arquitetura de informação, testes e o comportamento ao longo do tempo. O visual é só uma parte.

**"Design gráfico está ultrapassado pelo digital."**
Nada disso. O design gráfico é a **base** do UI e do UX, e continua insubstituível em impressão, identidade e comunicação visual. O digital **somou-se**, não substituiu.

**"No UX a estética não importa."**
Importa, mas **ao serviço da função**. Uma interface tem de ser clara e usável primeiro; bonita também, mas nunca à custa de funcionar.
