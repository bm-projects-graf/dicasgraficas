---
title: "Impressão de grande formato: solvente, eco-solvente, látex, UV e UV-gel"
description: "As tecnologias de tinta que imprimem lonas, vinis, montras e outdoors explicadas e comparadas: solvente, eco-solvente, látex, UV e UV-gel. Como cada uma seca, em que materiais resulta, o cheiro, a durabilidade e quando usar."
pubDate: 2026-07-20
category: "Processos de impressão"
keywords: "grande formato, impressão solvente, eco-solvente, látex, UV, UV gel, tintas impressão rolo, sinalética, roll-to-roll"
readingTime: "13 min"
featured: true
---

Outdoors, lonas, autocolantes de montra, telas de feira, decoração de viaturas, papel de parede — tudo isto é **impressão de grande formato**, quase sempre feita por [jato de tinta](/artigos/inkjet-de-producao-jato-de-tinta/) em **rolo** (*roll-to-roll*). Mas há uma decisão que muda tudo neste mundo, e que confunde quem entra nele: **o tipo de tinta**. Solvente, eco-solvente, látex, UV, UV-gel — são cinco tecnologias diferentes, e a escolha define em que materiais podes imprimir, quanto dura ao sol, se cheira mal, e até a qualidade do ar da tua oficina.
...
<div class="tech-box">
<div class="tech-label">Porque o "solvente" foi ficando "eco"</div>
<p>O solvente clássico imprime lindamente e dura imenso lá fora — mas o <strong>cheiro, os VOCs e a necessidade de ventilação</strong> tornaram-no incómodo (e, em muitos sítios, regulado). O <strong>eco-solvente</strong> manteve quase toda a versatilidade e durabilidade, mas tornou a impressão viável numa oficina normal, sem máscaras nem extração industrial. Daí ter-se tornado o padrão da sinalética de pequena e média escala.</p>
</div>
...
- **Materiais:** **praticamente todos** — porque a tinta fica **por cima** e cura na hora, adere a flexíveis e (em máquinas planas) a **rígidos** não absorventes: acrílico, madeira, vidro, metal, cartão. Ver [impressão plana](/artigos/impressao-plana-flatbed-grande-formato/).
...
| Tinta | Como seca | Odor / VOC | Pronta na hora? | Materiais | Exterior |
|-------|-----------|------------|-----------------|-----------|----------|
| **Solvente** | Solvente evapora (morde o material) | Alto | Não (desgaseifica) | Vinil, lona | Excelente |
| **Eco-solvente** | Solvente suave + calor | Baixo-médio | Quase | Vinil, lona, papel | Muito bom |
| **Látex** | Água evapora + polímero funde (calor) | Nenhum | **Sim** | Muito ampla, papel de parede, têxtil | Bom (c/ laminação) |
| **UV (LED)** | Cura UV instantânea | Baixo | **Sim** | Quase tudo, rígidos | Alto |
| **UV-gel** | Gel + cura UV | Baixo | **Sim** | Muito ampla, sensíveis ao calor | Alto |
...
**"Solvente e eco-solvente são a mesma coisa."**
São parentes, mas o **eco-solvente** usa solventes muito mais suaves: menos cheiro, menos VOC, viável numa oficina normal. O solvente clássico é mais agressivo e durável, mas exige ventilação séria.

**"Látex tem borracha."**
O nome engana. "Látex" refere-se às **partículas de polímero** na tinta aquosa que se fundem com o calor — não é borracha natural. A base é **água**, daí o baixo odor.

**"UV cura com calor."**
Não — cura com **luz ultravioleta**, não com calor. O LED-UV até aquece muito pouco, o que permite imprimir em materiais sensíveis ao calor.

**"UV-gel é só outra marca de UV."**
É uma abordagem distinta: a tinta é um **gel que solidifica ao contacto** antes da cura UV. Junta a versatilidade/baixo odor do látex à cura instantânea e durabilidade do UV.
